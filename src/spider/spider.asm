...
spider_spawn_definition::
    ...
    DB SPIDER_SPAWN_POINT_Y - SPRITE_HEIGHT, SPIDER_SPAWN_POINT_X + SPRITE_WIDTH  , SPIDER_WEB_HOOK_TILE_ID,  SPRITE_ATTR_PRIORITY_MASK                           ; Sprite 8: Columna 3, Fila 2
    DB 0, 0, 16, 6

    DB SPIDER_SPAWN_POINT_Y - SPRITE_HEIGHT, SPIDER_SPAWN_POINT_X + SPRITE_WIDTH*2, SPIDER_WEB_HOOK_TILE_ID + 2,  SPRITE_ATTR_PRIORITY_MASK                           ; Sprite 9: Columna 4, Fila 2
    DB 0, 0, 0, 0
