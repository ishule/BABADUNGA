...
gorilla_bullet_0_preset::
	DB 0
	DB GORILLA_BULLET_TILE_H, GORILLA_BULLET_TILE_V, GORILLA_BULLET_DAMAGE, GORILLA_BULLET_COLL_Y, GORILLA_BULLET_COLL_X
	DB GORILLA_BULLET_HEIGHT, GORILLA_BULLET_WIDTH, GORILLA_BULLET_SPEED_LOW, GORILLA_BULLET_SPEED_HIGH
gorilla_big_bullet_0_preset::
	DB 0
